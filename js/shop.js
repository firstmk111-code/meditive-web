...
(function (w, d) {
	...
	var QUOTE_IDS = ['pr05', 'pr06', 'pr07', 'pm01', 'pm08', 'pk01', 'pk02', 'pk03', 'pk04', 'pk05'];
	...
	var PRODUCTS = [
		...
		},
		{
			...
			opts: [{ name: '범위', list: [{ label: '로고 리터치 (기본)', add: 0 }, { label: '로고 + 서체 · 컬러 정리', add: 0 }, { label: '로고 + 기본 인쇄물 적용', add: 0 }] }],
			spec: { '구성': '로고 리디자인 · 사용 가이드', '산출물': '로고 원본 파일 (AI · PNG · SVG)', '제작기간': '2~3주', '포함': '시안 3회 수정' },
			include: ['로고 시안 3안 제안', '가로형 · 세로형 · 심볼 단독형 정리', '컬러 · 흑백 · 반전 버전 제공', '로고 사용 가이드 1부']
		}
	];
